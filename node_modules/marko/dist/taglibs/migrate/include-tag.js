...
module.exports = function migrator(elNode, context) {
    ...
    if (!rawArg) {
        context.addError(elNode, 'The <include(...)> tag must have an argument: <include("./target.marko")/> or <include(data.renderBody)/>');
    ...
    if (target.type === "Literal") {
        ...
        elNode.insertSiblingBefore(builder.htmlElement("if", undefined, [builder.text(target)], printJS(builder.binaryExpression(builder.unaryExpression(target, "typeof", true), "===", builder.literal("string")), context)));
        elNode.insertSiblingBefore(builder.htmlElement("else", undefined, [dynamicTag]));
        elNode.detach();
    }
};